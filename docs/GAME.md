...
The player explores a compact apartment, corridor, and outdoor courtyard with keyboard and mouse. Target first play: 8–12 minutes; an informed replay may be much faster.
...
7. Open the service door and walk outside. Arai has identified the missing panel in a courtyard drain. A folded figure lunges into view when the player enters the yard: scare 1, once per run.
8. Find a paper boat on the bench. It reproduces a private childhood memory. Unfold it to collect a ceramic fuse. A second close apparition appears as the player looks up: scare 2, once per run.
9. Carry the fuse to the red cabinet. Fitting it restores the courtyard light and reveals the drain. A voice imitates the player's father, but uses a name that exists only in the manga.
10. Pull the missing panel from the barred drain. Its creature is made of folded pages containing familiar faces. The Fold fills the view as the panel comes free: scare 3, once per run. The player can then return through the open service door; there is no chase or death loop.
11. Return to the apartment. If the red light went out, 402 is physically covered by a blank wall and your door reads 000. If it stayed on, 402 remains and your door still reads 404. The clock moves to 00:00 or 00:09 respectively.
12. Re-enter the room and inspect the recovered panel on the desk. The room is cold and dim if you obeyed; the desk is warmly lit if you resisted. Both routes have a complete ending and replay.

Optional object descriptions enrich the room but never lock progress. Every required step has an objective hint. The duration is a target, not a measured first-player completion time.
...
**The delivery:** obey the page. The witness disappears, your apartment becomes 000, and the recovered panel finishes the creature's copy of your face. Your fingers fold into paper as you make the telephone call. Another boat waits outside. You have become the caller who guides the next tenant into the same choice.

**Outside the frame:** trust the witness. Arai's signature crosses out the figure's face on the recovered panel. Her memory survived because the red light stayed on. The clock advances beyond 00:08 and the courtyard swing stops. You fold the page into a boat yourself. The loop is broken locally, but the origin of the chapters remains unresolved.
